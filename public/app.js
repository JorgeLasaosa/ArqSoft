...
(function()
{
   ...
   {
      this.frameSelected = 'views/start.html';
   ...
   {
      return {
         templateUrl: "views/search-thumbnail.html"
      };
   });
   ...
   {
      return {
         templateUrl: "views/most-rated-thumbnail.html"
      };
   });
   ...
   {
      return {
         templateUrl: "views/most-reviewed-thumbnail.html"
      };
   });
   ...
   {
      return {
         templateUrl: "views/new-arrivals-thumbnail.html"
      };
   });
